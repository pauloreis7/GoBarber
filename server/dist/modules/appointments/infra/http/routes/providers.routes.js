...
var _ListProviderMonthAvailabilityController = _interopRequireDefault(require("../controllers/ListProviderMonthAvailabilityController"));

var _ListProviderDayAvailabilityController = _interopRequireDefault(require("../controllers/ListProviderDayAvailabilityController"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

const providersRouter = (0, _express.Router)();
const providersController = new _ProvidersController.default();
const providerMonthAvailabilityController = new _ListProviderMonthAvailabilityController.default();
const providerDayAvailabilityController = new _ListProviderDayAvailabilityController.default();
